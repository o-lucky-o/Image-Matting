...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt-path', type=str, default='modnet_epoch_21.pth',help='path of the checkpoint that will be converted')
    parser.add_argument('--output-path', type=str, default='modnet_epoch_21.onnx', help='path for saving the ONNX model')
