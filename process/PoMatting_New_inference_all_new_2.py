...
#https://blog.csdn.net/weixin_38678501/article/details/91961855?ops_request_misc=&request_id=&biz_id=102&utm_term=pyqt%20%E5%A4%9A%E6%91%84%E5%83%8F%E5%A4%B4&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduweb~default-0-91961855.nonecase&spm=1018.2226.3001.4187
...
class MyWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # 定义时间超时连接start_app
        #self.worki = WorkThread()
        #self.worki.trigger.connect(self.inputvideo)

        self.worko = WorkThread()
        #self.worko.trigger.connect(self.outputvideo)
